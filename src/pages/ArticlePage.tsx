...
const ArticlePage: React.FC = () => {
  ...
  async function addComment() {
    ...
    sendCommentData(articleId || "No Article Provided", message)

    setDiscussion((oldArray) => [...oldArray, message]);
          ...
          <div className="bg-white rounded-lg shadow-scholarly-card p-6 mb-6">
            <div className="mb-6">
              ...
              <div className="flex space-x-3 mb-4">
                ...
                <button
                  onClick={handleLike}
                  className={`flex items-center space-x-1 ${isLiked ? 'text-green-500' : 'text-scholarly-secondaryText'} hover:text-green-500`}
                >
                ...
                <button
                  ...
                  className={`flex items-center space-x-1 ${isDisliked ? 'text-red-500' : 'text-scholarly-secondaryText'} hover:text-red-500`}
                >
